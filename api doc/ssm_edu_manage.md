...
|»» updatedTime|[integer]|false|none||none|
...
|»»» createdBy|string|true|none||none|
|»»» updatedBy|string|true|none||none|
|»»» subMenuList|[string]|true|none||none|
...
|名称|位置|类型|必选|说明|
|---|---|---|---|---|
|id|query|integer| 是 |菜单 id。新增菜单，则 id 为 -1；修改，则为选择的 id 值|
...
|状态码|状态码含义|说明|数据模型|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|新增页面回显成功|Inline|
...
|» message|string|true|none||none|
|» content|object|true|none||none|
|»» menuInfo|null|true|none||none|
|»» parentMenuList|[object]|true|none||none|
|»»» id|integer|true|none||none|
|»»» parentId|integer|true|none||none|
|»»» href|string|true|none||none|
|»»» icon|string|true|none||none|
...
|» shown|body|integer| 是 |none|
|» level|body|integer| 是 |none|
|» createdBy|body|string| 是 |none|
|» updatedBy|body|string| 是 |none|
...
|---|---|---|---|---|
|body|body|object| 否 |none|
|» currentPage|body|integer| 是 |当前的页码|
|» pageSize|body|integer| 是 |每页显示记录条数|
|» name|body|string| 否 |资源名称|
|» categoryId|body|integer| 否 |资源分类 id|
|» url|body|string| 否 |资源路径|
...
## POST saveOrUpdateResourceCategory
...
|---|---|---|---|---|
|body|body|object| 否 |none|
|» id|body|integer| 否 |资源分类的 id，新增时不需要，修改时需要|
|» name|body|string| 是 |none|
